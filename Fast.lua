...
function Dev(msg) 
ok = false
local list = {Sudo_Id,1001132193,1099460779,1050898456}
...
send(data.chat_id,data.id," ※ اهلا بك مطوري سمير \n","md",true, false, false, true, reply_markup)
return false 
end
---
...
send(data.chat_id,data.id,"※ اهلا بك في صانع بوتات ميوزك سورس اسنـاك \n※ مطور البوت @S_TTUTT1","html",true, false, false, true, reply_markup)
return false 
end
---making user
